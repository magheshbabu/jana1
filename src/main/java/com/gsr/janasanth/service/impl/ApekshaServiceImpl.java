...
public class ApekshaServiceImpl implements ApekshaService {
	...
	public ApekshaDTO save(ApekshaDTO apekshaDTO) {
		...
		// THIS IS BEING DONE BECAUSE, WE DONT WANT TO STORE FILES IN DB. WE
		// WANT TO STORE FILE IN FILESYSTEM
		// IN DB, WE JUST SAVE THE FILE NAME
		byte[] additionalDocument = apeksha.getAdditionalDocuments();
		...
		String additionalDocumentFileName = "additional_document_" + UUID.randomUUID().toString();
		...
		try {
			fileService.saveBytestoDisk(additionalDocument, properties.getApeksha().getFileRoot() + apeksha.getId() + "/",
		...
		if (additionalDocument != null) {
			apeksha.additionalDocuments(additionalDocumentFileName.getBytes(Charset.forName("UTF-8")));
		}
		if (photo != null) {
		...
		if (nomineeAadharCardRationCard != null) {
			apeksha.nomineeAadharCardRationCard(nomineeAadharCardRationCardfileName.getBytes(Charset.forName("UTF-8")));
		}

		if (nomineeRelationShipProof != null) {
			apeksha.nomineeRelationShipProof(nomineeRelationShipProoffileName.getBytes(Charset.forName("UTF-8")));
		}

		if (nomineeBankPassbookFrontPage != null) {
			apeksha.nomineeBankPassbookFrontPage(
					nomineeBankPassbookFrontPagefileName.getBytes(Charset.forName("UTF-8")));
		}
	...
	private ApekshaDTO toDto(Apeksha apeksha) {
		...
		return dto;
		// if (null != dto.getAdditionalDocuments() &&
		// dto.getAdditionalDocuments().length > 0) {
		// String fileName = new String(dto.getAdditionalDocuments(),
		// Charset.forName("UTF-8"));
		//
		// try {
		// dto.setAdditionalDocuments(fileService
		// .readBytesFromDisk(properties.getApeksha().getFileRoot() +
		// apeksha.getId() + "/", fileName));
		// } catch (IOException e) {
		// // TODO Auto-generated catch block
		// e.printStackTrace();
		// }
		...
		//
		// if (null != dto.getPhoto() && dto.getPhoto().length > 0) {
		// String photofileName = new String(dto.getPhoto(),
		// Charset.forName("UTF-8"));
		//
		// try {
		// dto.setPhoto(fileService.readBytesFromDisk(
		...
		// }
		//
		// if (null != dto.getApplicationForm() &&
		// dto.getApplicationForm().length > 0) {
		// String applicationFormfileName = new String(dto.getApplicationForm(),
		// Charset.forName("UTF-8"));
		//
		// try {
		...
		// String aadharCardfileName = new String(dto.getAadharCard(),
		// Charset.forName("UTF-8"));
		//
		// try {
		...
		// String rationCardfileName = new String(dto.getRationCard(),
		// Charset.forName("UTF-8"));
		//
		// try {
		...
		// }
		//
		// if (null != dto.getDoctorReport() && dto.getDoctorReport().length >
		// 0) {
		// String doctorReportfileName = new String(dto.getDoctorReport(),
		// Charset.forName("UTF-8"));
		//
		// try {
		...
		// }
		//
		// if (null != dto.getBankPassbookFrontPage() &&
		// dto.getBankPassbookFrontPage().length > 0) {
		// String bankPassbookFrontPagefileName = new
		// String(dto.getBankPassbookFrontPage(), Charset.forName("UTF-8"));
		//
		// try {
		// dto.setBankPassbookFrontPage(fileService.readBytesFromDisk(
		// properties.getApeksha().getFileRoot() + apeksha.getId() + "/",
		// bankPassbookFrontPagefileName));
		// } catch (IOException e) {
		// // TODO Auto-generated catch block
		// e.printStackTrace();
		// }
		// }
		//
		// if (null != dto.getNomineePhoto() && dto.getNomineePhoto().length >
		// 0) {
		// String nomineePhotofileName = new String(dto.getNomineePhoto(),
		// Charset.forName("UTF-8"));
		//
		// try {
		...
		// }
		//
		// if (null != dto.getNomineeAadharCardRationCard() &&
		// dto.getNomineeAadharCardRationCard().length > 0) {
		// String nomineeAadharCardRationCardfileName = new
		// String(dto.getNomineeAadharCardRationCard(),
		// Charset.forName("UTF-8"));
		//
		// try {
		// dto.setNomineeAadharCardRationCard(
		// fileService.readBytesFromDisk(properties.getApeksha().getFileRoot() +
		// apeksha.getId() + "/",
		...
		// }
		//
		// if (null != dto.getNomineeRelationShipProof() &&
		// dto.getNomineeRelationShipProof().length > 0) {
		// String nomineeRelationShipProoffileName = new
		// String(dto.getNomineeRelationShipProof(),
		// Charset.forName("UTF-8"));
		//
		// try {
		...
		// }
		//
		// if (null != dto.getNomineeBankPassbookFrontPage() &&
		// dto.getNomineeBankPassbookFrontPage().length > 0) {
		// String nomineeBankPassbookFrontPagefileName = new
		// String(dto.getNomineeBankPassbookFrontPage(),
		// Charset.forName("UTF-8"));
		//
		// try {
